...
st.markdown(
    ...
    <style>
      ...
      @media (min-width:0px) {
        :root { --ink:#fbf7ff; --muted:#d8cee1; --surface:#211928; --surface-2:#2e2338;
        ...
        .stApp:before { width:24rem; height:24rem; right:-10rem; bottom:-12rem;
                        background:linear-gradient(135deg,rgba(224,150,194,.13),rgba(174,105,168,.10));
                        filter:blur(28px); }
        ...
        .gift-art { right:.8rem; top:.65rem; transform:scale(.88); transform-origin:top right; opacity:.76; }
        .hero p { color:#ddd3e5; }
        [data-testid="stWidgetLabel"] p, [data-testid="stWidgetLabel"] label,
        [data-testid="stCaptionContainer"] p { color:#ded4e6 !important; }
